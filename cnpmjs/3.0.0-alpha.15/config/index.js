...
var dataDir = '/var/data/cnpm_data';
...
var config = {
  ...
  // page mode, enable on debug mode
  pagemock: process.env.DEBUG === 'true',
  // session secret
  ...
  // registry url name
  registryHost: process.env.REGISTRY_HOST || 'r.cnpmjs.org',
  ...
  enablePrivate: process.env.ENABLE_PRIVATE === 'true',
  ...
  officialNpmRegistry: process.env.OFFICIAL_NPM_REGISTRY || 'https://registry.npmjs.com',
  officialNpmReplicate: process.env.OFFICIAL_NPM_REPLICATE || 'https://replicate.npmjs.com',

  // sync source, upstream registry
  // If you want to directly sync from official npm's registry
  // please drop them an email first
  sourceNpmRegistry: process.env.SOURCE_NPM_REGISTRY || 'https://registry.npm.taobao.org',
  ...
  syncModel: process.env.SYNC_MODEL || 'exist', // 'none', 'all', 'exist'

  syncConcurrency: 1,
  // sync interval, default is 10 minutes
  syncInterval: process.env.SYNC_INTERVAL || '10m',
